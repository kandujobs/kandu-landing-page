          ...
          >
            ...
            {[
              ...
              { 
                ...
                logo: (
                  <svg viewBox="0 0 24 24" className="w-8 h-8">
                    <path fill="#E01E5A" d="M6.5 0C4.567 0 3 1.567 3 3.5S4.567 7 6.5 7 10 5.433 10 3.5 8.433 0 6.5 0zm0 2C7.327 2 8 2.673 8 3.5S7.327 5 6.5 5 5 4.327 5 3.5 5.673 2 6.5 2z"/>
                    <path fill="#36C5F0" d="M17.5 6.5C15.567 6.5 14 8.067 14 10s1.567 3.5 3.5 3.5S21 11.933 21 10s-1.567-3.5-3.5-3.5zm0 2c.827 0 1.5.673 1.5 1.5s-.673 1.5-1.5 1.5S16 10.327 16 9.5s.673-1.5 1.5-1.5z"/>
                    <path fill="#2EB67D" d="M17.5 14C19.433 14 21 15.567 21 17.5S19.433 21 17.5 21 14 19.433 14 17.5 15.567 14 17.5 14zm0 2c-.827 0-1.5.673-1.5 1.5s.673 1.5 1.5 1.5S19 18.327 19 17.5s-.673-1.5-1.5-1.5z"/>
                    <path fill="#ECB22E" d="M6.5 17.5C4.567 17.5 3 19.067 3 21s1.567 3.5 3.5 3.5S10 22.933 10 21 8.433 17.5 6.5 17.5zm0 2c-.827 0-1.5.673-1.5 1.5s.673 1.5 1.5 1.5S8 21.327 8 20.5s-.673-1.5-1.5-1.5z"/>
                  </svg>
                )
              },
              { 
