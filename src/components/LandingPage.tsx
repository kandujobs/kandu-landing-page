          ...
          >
            ...
            {[
              ...
              { 
                ...
                logo: (
                  <svg viewBox="0 0 24 24" className="w-8 h-8">
                    <path fill="#FF9900" d="M6.763 12.896c-.108-.108-.108-.216 0-.324l8.748-8.748c.108-.108.216-.108.324 0l1.404 1.404c.108.108.108.216 0 .324L8.487 14.624c-.108.108-.216.108-.324 0L6.763 12.896z"/>
                    <path fill="#232F3E" d="M6.763 12.896c-.108-.108-.108-.216 0-.324l8.748-8.748c.108-.108.216-.108.324 0l1.404 1.404c.108.108.108.216 0 .324L8.487 14.624c-.108.108-.216.108-.324 0L6.763 12.896z"/>
                    <path fill="#FF9900" d="M12.896 6.763c.108-.108.216-.108.324 0l8.748 8.748c.108.108.108.216 0 .324l-1.404 1.404c-.108.108-.216.108-.324 0L11.492 8.487c-.108-.108-.108-.216 0-.324l1.404-1.404z"/>
                    <path fill="#232F3E" d="M12.896 6.763c.108-.108.216-.108.324 0l8.748 8.748c.108.108.108.216 0 .324l-1.404 1.404c-.108.108-.216.108-.324 0L11.492 8.487c-.108-.108-.108-.216 0-.324l1.404-1.404z"/>
                  </svg>
                )
              },
              { 
