          ...
          >
            ...
            {[
              ...
              { 
                ...
                logo: (
                  <svg viewBox="0 0 24 24" className="w-8 h-8">
                    <path fill="#E50914" d="M5.398 0v.006c3.028 8.556 5.37 15.175 8.348 23.596 2.344.058 4.85.398 4.854.398-2.8-7.924-5.923-16.747-8.487-24zm13.464 0c-1.17 0-2.294.02-3.378.075v24c1.084.055 2.208.075 3.378.075 5.4 0 9.738-4.338 9.738-9.737S24.262 0 18.862 0z"/>
                  </svg>
                )
              },
              { 
