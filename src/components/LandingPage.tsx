          ...
          >
            ...
            {[
              ...
              { 
                ...
                logo: (
                  <svg viewBox="0 0 24 24" className="w-8 h-8">
                    <path fill="#000000" d="M0 18v3h3v-3H0zm5 0v3h3v-3H5zm5 0v3h3v-3h-3zm5 0v3h3v-3h-3zm5 0v3h3v-3h-3zM0 13v3h3v-3H0zm5 0v3h3v-3H5zm5 0v3h3v-3h-3zm5 0v3h3v-3h-3zm5 0v3h3v-3h-3zM0 8v3h3V8H0zm5 0v3h3V8H5zm5 0v3h3V8h-3zm5 0v3h3V8h-3zm5 0v3h3V8h-3zM0 3v3h3V3H0zm5 0v3h3V3H5zm5 0v3h3V3h-3zm5 0v3h3V3h-3zm5 0v3h3V3h-3z"/>
                  </svg>
                )
              },
              { 
